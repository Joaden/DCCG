 ...
 */
final class Version20211112110428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD auteur_id INT DEFAULT NULL, DROP auteur_id_id, DROP article_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5F9E962A60BB6FE6 ON comments');
        $this->addSql('ALTER TABLE comments ADD article_id_id INT DEFAULT NULL, CHANGE auteur_id auteur_id_id INT DEFAULT NULL');
